...
from common.helper.ScreenActions import move_mouse, click
from common.utils.ContextActionExecutor import ContextActionExecutor  # Ensure 'common/utils/context_action_executor.py' exists and is in your PYTHONPATH
...
class SimpleClicker(BaseTool):
    ...
    def load_tasks(self, mode=DEFAULT_MODE):
        ...
        for task_config in task_configs:
            detector_configs = task_config.get('detector_configs', [])
            area = task_config.get('area', {})
