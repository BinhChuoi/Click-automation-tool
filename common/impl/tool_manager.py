...
class _ToolManager:
    ...
    def start_new_task(self, execution_type, task_id, on_detection=None, on_stop=None, sleep_period=2, detectors=[], area=None):
        ...
        from common.base.detection_task import DetectionTask
        task_config = {
    ...
    def build(self, tool_type, tool_data=None, tool_config=None):
        ...
        """
        tool_class = None
        if tool_type == 'harvestor':
            from tools.harvestor import Harvestor
            tool_class = Harvestor
        elif tool_type == 'captcha_passer':
            from tools.captcha_passer import CaptchaPasser
            tool_class = CaptchaPasser
        elif tool_type == 'simple_clicker':
            from tools.simple_clicker import SimpleClicker
